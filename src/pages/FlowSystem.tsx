...
import AlertSystem from '@/components/flow/AlertSystem';
import TaskPrioritization from '@/components/flow/TaskPrioritization';
      ...
      <div className="flex-1 overflow-auto">
        <div className="container mx-auto p-6 space-y-6">
          <div className="flex flex-col space-y-2">
            <h1 className="text-3xl font-bold tracking-tight">FLOW System</h1>
            <p className="text-muted-foreground">
              Flexible Logistics & Operational Workflow system for process optimization and task management.
            </p>
          </div>
              ...
              <DialogContent>
                <form onSubmit={handleCreateProject}>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Add a new project to manage with the FLOW system.
                    </DialogDescription>
                  </DialogHeader>
          ...
          {!selectedProjectId && projects.length === 0 && !isLoading ? (
            <div className="mt-8 text-center p-8 border border-dashed border-gray-500 rounded-lg">
              ...
              <p className="text-gray-400 mb-4">Create your first project to get started with the FLOW system.</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <EfficiencyAnalysis projectId={selectedProjectId} />
              <AlertSystem projectId={selectedProjectId} />
              <TaskPrioritization projectId={selectedProjectId} />
            </div>
          )}
        </div>
      </div>
